...
|----|--------|-------|--------|-----|------|------|---------|-------|
| S002 | @yuliuyi717-ux | State-model coupling | YES_WITH_CAVEATS | 4 | 3 | 3 | 3 | Valid observation, overstated significance. [PR#255](https://github.com/peteromallet/desloppify/pull/255) |
